  ...
  return (
    <section className="py-20 bg-surface-canvas border-b border-surface-border" id="perbandingan">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div 
          className="overflow-x-auto reveal-init"
          ...
          <table className="w-full text-left border-collapse bg-white rounded-2xl overflow-hidden paper-shadow min-w-[640px]">
            <thead>
              <tr className="border-b border-surface-border bg-slate-50/70 text-xs uppercase tracking-wider text-slate-500 font-bold">
                ...
                <th className="py-5 px-6 text-brand-800 bg-brand-50/60 font-black">CVKu (Indonesia)</th>
            ...
            <tbody className="divide-y divide-surface-border text-sm">
              <tr className="hover:bg-slate-50/80 transition-colors">
                ...
                <td className="py-4 px-6 font-bold text-brand-700 bg-brand-50/30">100% Gratis Selamanya</td>
              ...
              <tr className="hover:bg-slate-50/80 transition-colors">
                ...
                <td className="py-4 px-6 font-bold text-brand-700 bg-brand-50/30">Tanpa Watermark</td>
              ...
              <tr className="hover:bg-slate-50/80 transition-colors">
                ...
                <td className="py-4 px-6 font-bold text-brand-700 bg-brand-50/30">99.8% Lolos Screening Bot</td>
              ...
              <tr className="hover:bg-slate-50/80 transition-colors">
                ...
                <td className="py-4 px-6 font-bold text-brand-700 bg-brand-50/30">Sangat Natural &amp; Kontekstual</td>
              ...
              <tr className="hover:bg-slate-50/80 transition-colors">
                ...
                <td className="py-4 px-6 font-bold text-brand-700 bg-brand-50/30">Tanpa Login (Langsung Pakai)</td>
